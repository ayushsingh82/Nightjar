...
// `proveReputation` disclosed, which is why every card is tagged on-chain.
        ...
        {sellers.map((seller) => {
          ...
          return (
            ...
            >
              ...
              <Row label="Bond staked (on chain)" tone="public">
                {money(bond)}
              </Row>
              <Button
                // An unhireable agent should read as "nothing to act on", not
                // "action greyed out" — so only a hireable card gets the solid
                // signal-orange block.
